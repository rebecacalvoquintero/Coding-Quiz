...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {searchInput: a, patients: b, pageSize: c, currentPage: d, sorting: e, focusedPatientId: f};
	});
var _user$project$Model$Patient = F6(
	function (a, b, c, d, e, f) {
		return {lastName: a, firstName: b, dob: c, gender: d, title: e, telecoms: f};
	});
var _user$project$Model$Telecom = F2(
	function (a, b) {
		return {usage: a, value: b};
	});
var _user$project$Model$None = {ctor: 'None'};
var _user$project$Model$Desc = function (a) {
	return {ctor: 'Desc', _0: a};
};
var _user$project$Model$Asc = function (a) {
	return {ctor: 'Asc', _0: a};
};
var _user$project$Model$Dob = {ctor: 'Dob'};
var _user$project$Model$LastName = {ctor: 'LastName'};
var _user$project$Model$FirstName = {ctor: 'FirstName'};

var _user$project$Messages$UnfocusPatient = {ctor: 'UnfocusPatient'};
var _user$project$Messages$SetFocusedPatient = function (a) {
	return {ctor: 'SetFocusedPatient', _0: a};
};
var _user$project$Messages$SetPatients = function (a) {
	return {ctor: 'SetPatients', _0: a};
};
var _user$project$Messages$SetPage = function (a) {
	return {ctor: 'SetPage', _0: a};
};
var _user$project$Messages$PreviousPage = {ctor: 'PreviousPage'};
var _user$project$Messages$NextPage = {ctor: 'NextPage'};
var _user$project$Messages$SetSorting = function (a) {
	return {ctor: 'SetSorting', _0: a};
};
var _user$project$Messages$UpdateInput = function (a) {
	return {ctor: 'UpdateInput', _0: a};
};

var _user$project$ApiGet$telecomDecoder = A3(
	...
	A3(
		...
		'usage',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Telecom)));
var _user$project$ApiGet$patientDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'telecoms',
	_elm_lang$core$Json_Decode$list(_user$project$ApiGet$telecomDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'prefix',
		_elm_lang$core$Json_Decode$string,
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'lastName',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Patient)))))));
var _user$project$ApiGet$initialDataDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'content',
	...
	_elm_lang$core$Json_Decode$list(_user$project$ApiGet$patientDecoder));
var _user$project$ApiGet$getInitialData = function () {
	var url = 'https://api.interview.healthforge.io:443/api/patient?size=1000';
	var request = A2(_elm_lang$http$Http$get, url, _user$project$ApiGet$initialDataDecoder);
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'UpdateInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{searchInput: _p0._0, currentPage: 0}),
			...
			case 'SetPatients':
				if (_p0._0.ctor === 'Err') {
					var x = A2(_elm_lang$core$Debug$log, 'x', _p0._0._0);
			...
			case 'SetFocusedPatient':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							focusedPatientId: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$ViewPatient$viewTelecoms = function (patient) {
	var viewTelecom = F2(
		function (i, t) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('ml2'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(t.usage),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(t.value),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
	...
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$indexedMap, viewTelecom, patient.telecoms));
};
var _user$project$ViewPatient$view = F2(
	function (model, patient) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('center pl6 pt4 f4'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(patient.firstName),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(patient.lastName),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'd MMMM, y', patient.dob)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(patient.gender),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(patient.title),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Telecoms: '),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _user$project$ViewPatient$viewTelecoms(patient),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$UnfocusPatient),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('shadow-hover button f3 pa2 ma2'),
													_1: {ctor: '[]'}
												}
											},
											{
...
var _user$project$View$viewPatientRow = function (patient) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Messages$SetFocusedPatient(patient)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('shadow-hover'),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View$patientsComparator = F3(
	function (sorting, patient1, patient2) {
		var _p0 = sorting;
		switch (_p0.ctor) {
			case 'None':
			...
			case 'Asc':
				switch (_p0._0.ctor) {
					case 'FirstName':
						return A2(_elm_lang$core$Basics$compare, patient1.firstName, patient2.firstName);
					case 'LastName':
						return A2(_elm_lang$core$Basics$compare, patient1.lastName, patient2.lastName);
					default:
						return A2(_justinmimbs$elm_date_extra$Date_Extra$compare, patient1.dob, patient2.dob);
				}
			default:
				switch (_p0._0.ctor) {
					case 'FirstName':
						return A2(_elm_lang$core$Basics$compare, patient2.firstName, patient1.firstName);
					case 'LastName':
						return A2(_elm_lang$core$Basics$compare, patient2.lastName, patient1.lastName);
					default:
						return A2(_justinmimbs$elm_date_extra$Date_Extra$compare, patient2.dob, patient1.dob);
				}
		}
	});
var _user$project$View$filterBySearch = F2(
	function (searchInput, patient) {
		var ciContains = function (string) {
			return A2(
				_elm_lang$core$String$contains,
				_elm_lang$core$String$toLower(searchInput),
				_elm_lang$core$String$toLower(string));
		};
		return ciContains(patient.firstName) || (ciContains(patient.lastName) || ciContains(
			A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'd MMMM, y', patient.dob)));
	});
var _user$project$View$viewTable = function (model) {
	var filteredPatients = A2(
		_elm_lang$core$List$filter,
		_user$project$View$filterBySearch(model.searchInput),
		model.patients);
	var patientsOnPage = A2(
		_elm_lang$core$List$take,
		model.pageSize,
		A2(_elm_lang$core$List$drop, model.pageSize * model.currentPage, filteredPatients));
	var morePatientsAfterPage = _elm_lang$core$Native_Utils.cmp(
		(model.currentPage + 1) * model.pageSize,
		_elm_lang$core$List$length(filteredPatients)) < 0;
	var pageCount = _elm_lang$core$Basics$ceiling(
		_elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(filteredPatients)) / _elm_lang$core$Basics$toFloat(model.pageSize));
	var pages = A2(_elm_lang$core$List$range, 1, pageCount);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tableBox'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('tableHeader f4 br5 pa3'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('borderbox fl ma2 tc'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Messages$SetSorting(
																_user$project$Model$Asc(_user$project$Model$LastName))),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('image tc'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$src('https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2014/png/iconmonstr-sort-13.png&r=0&g=0&b=0'),
																	_1: {ctor: '[]'}
																}
															},
															{ctor: '[]'}),
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Messages$SetSorting(
																	_user$project$Model$Desc(_user$project$Model$LastName))),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$img,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$src('https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2014/png/iconmonstr-sort-16.png&r=0&g=0&b=0'),
																		_1: {ctor: '[]'}
																	}
																},
																{ctor: '[]'}),
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Messages$SetSorting(
																	_user$project$Model$Asc(_user$project$Model$FirstName))),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_0: _elm_lang$html$Html_Events$onClick(
																	_user$project$Messages$SetSorting(
																		_user$project$Model$Desc(_user$project$Model$FirstName))),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_1: {
																	...
																	_0: _elm_lang$html$Html_Events$onClick(
																		_user$project$Messages$SetSorting(
																			_user$project$Model$Asc(_user$project$Model$Dob))),
																	_1: {ctor: '[]'}
																}
															},
															{
																...
																_0: A2(
																	_elm_lang$html$Html$img,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$src('https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2014/png/iconmonstr-sort-18.png&r=0&g=0&b=0'),
																			_1: {ctor: '[]'}
																		}
																	},
																	{ctor: '[]'}),
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$button,
																{
																	...
																	_0: _elm_lang$html$Html_Events$onClick(
																		_user$project$Messages$SetSorting(
																			_user$project$Model$Desc(_user$project$Model$Dob))),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$img,
																		{
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$src('https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2014/png/iconmonstr-sort-20.png&r=0&g=0&b=0'),
																				_1: {ctor: '[]'}
																			}
																		},
																		{ctor: '[]'}),
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tableBody ma2 f5 ma2 br5 pa2'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
								_user$project$View$viewPatientRow,
								A2(
									_elm_lang$core$List$sortWith,
									_user$project$View$patientsComparator(model.sorting),
									patientsOnPage))),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('footerContainerParent'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('center footerContainer'),
								_1: {ctor: '[]'}
							},
							function () {
								var pageDropdown = A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('page-dropdown f3 pa2'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$SetPage),
											_1: {ctor: '[]'}
										}
									},
									A2(
											...
											return A2(
												_elm_lang$html$Html$option,
												{
													...
													_0: _elm_lang$html$Html_Attributes$selected(
														_elm_lang$core$Native_Utils.eq(n - 1, model.currentPage)),
													_1: {
														ctor: '::',
								...
								var next = A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$NextPage),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$disabled(!morePatientsAfterPage),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('next shadow-hover button next f3 pa2 ma2 fr'),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								var previous = A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$PreviousPage),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$disabled(
												_elm_lang$core$Native_Utils.eq(model.currentPage, 0)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('previous shadow-hover button previous f3 pa2 ma2 fl'),
												_1: {ctor: '[]'}
											}
										}
									},
...
var _user$project$View$viewNavBar = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('navBar w-100 h4 tc f3 white'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('../assets/healthforge_logo.png'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('logo tc'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('title ma1 pa2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: function () {
					var _p1 = model.focusedPatientId;
					if (_p1.ctor === 'Nothing') {
						return A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$UpdateInput),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.searchInput),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('searchBar center db w-75 w-50-m w-33-l f3 pa2 ma4'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder('start your search'),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									ctor: '::',
									_0: _user$project$View$viewTable(model),
									_1: {ctor: '[]'}
								}
							});
					} else {
						return A2(_user$project$ViewPatient$view, model, _p1._0);
					}
				}(),
				_1: {ctor: '[]'}
			}
